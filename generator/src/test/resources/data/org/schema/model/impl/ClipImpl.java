...
public class ClipImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Clip {
    ...
    private List<Object> clipNumber;
    ...
    public void addClipNumber(Integer clipNumber) {
        this.clipNumber = add(this.clipNumber, clipNumber);
    }
    /**
     * Position of the clip within an ordered group of clips.
     *
    ...
    private List<Episode> partOfEpisode;
    ...
    public void addPartOfEpisode(Episode partOfEpisode) {
        this.partOfEpisode = add(this.partOfEpisode, partOfEpisode);
    }
    ...
    private List<Object> startOffset;
     ...
     */
    @Override
    public <T> List<T> getStartOffsetList() {
        return (List<T>) startOffset;
    }
     ...
     */
    @Override
    public <T> T getStartOffset() {
        return (T) getFirst(startOffset);
    }
     ...
     */
    @Override
    public void addStartOffset(Number startOffset) {
        this.startOffset = add(this.startOffset, startOffset);
    }
    /**
     * The start time of the clip expressed as the number of seconds from the beginning of the work.
     *
     ...
     */
    @Override
    public void addStartOffset(HyperTocEntry startOffset) {
        this.startOffset = add(this.startOffset, startOffset);
    }
     ...
     */
    @Override
    public <T> List<T> getEndOffsetList() {
        return (List<T>) endOffset;
    }
     ...
     */
    @Override
    public <T> T getEndOffset() {
        return (T) getFirst(endOffset);
    }
     ...
     */
    @Override
    public void addEndOffset(Number endOffset) {
        this.endOffset = add(this.endOffset, endOffset);
    }
    /**
     * The end time of the clip expressed as the number of seconds from the beginning of the work.
     *
     ...
     */
    @Override
    public void addEndOffset(HyperTocEntry endOffset) {
        this.endOffset = add(this.endOffset, endOffset);
    }
