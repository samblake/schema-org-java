...
public class DietImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Diet {
     ...
     */
    @Override
    public <T> List<T> getEndorsersList() {
        return (List<T>) endorsers;
    }
     ...
     */
    @Override
    public <T> T getEndorsers() {
        return (T) getFirst(endorsers);
    }
     ...
     */
    @Override
    public void addEndorsers(Person endorsers) {
        this.endorsers = add(this.endorsers, endorsers);
    }
    /**
     * People or organizations that endorse the plan.
     *
     ...
     */
    @Override
    public void addEndorsers(Organization endorsers) {
        this.endorsers = add(this.endorsers, endorsers);
    }

    private List<Text> dietFeatures;
     ...
     */
    @Override
    public List<Text> getDietFeaturesList() {
        return dietFeatures;
    }
     ...
     */
    @Override
    public Text getDietFeatures() {
        return getFirst(dietFeatures);
    }
     ...
     */
    @Override
    public void addDietFeatures(Text dietFeatures) {
        this.dietFeatures = add(this.dietFeatures, dietFeatures);
    }

    private List<Text> physiologicalBenefits;
     ...
     */
    @Override
    public List<Text> getPhysiologicalBenefitsList() {
        return physiologicalBenefits;
    }
     ...
     */
    @Override
    public Text getPhysiologicalBenefits() {
        return getFirst(physiologicalBenefits);
    }
     ...
     */
    @Override
    public void addPhysiologicalBenefits(Text physiologicalBenefits) {
        this.physiologicalBenefits = add(this.physiologicalBenefits, physiologicalBenefits);
    }

    private List<Text> expertConsiderations;
     ...
     */
    @Override
    public List<Text> getExpertConsiderationsList() {
        return expertConsiderations;
    }
     ...
     */
    @Override
    public Text getExpertConsiderations() {
        return getFirst(expertConsiderations);
    }
     ...
     */
    @Override
    public void addExpertConsiderations(Text expertConsiderations) {
        this.expertConsiderations = add(this.expertConsiderations, expertConsiderations);
    }

    private List<Text> risks;
     ...
     */
    @Override
    public Text getRisks() {
        return getFirst(risks);
    }
     ...
     */
    @Override
    public void addRisks(Text risks) {
        this.risks = add(this.risks, risks);
    }
