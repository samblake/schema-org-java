...
public class BlogImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Blog {
    ...
    private List<BlogPosting> blogPosts;
     ...
     */
    @Override
    public List<BlogPosting> getBlogPostsList() {
        return blogPosts;
    }
     ...
     */
    @Override
    public void addBlogPosts(BlogPosting blogPosts) {
        this.blogPosts = add(this.blogPosts, blogPosts);
    }

    private List<BlogPosting> blogPost;
     ...
     */
    @Override
    public List<BlogPosting> getBlogPostList() {
        return blogPost;
    }
     ...
     */
    @Override
    public void addBlogPost(BlogPosting blogPost) {
        this.blogPost = add(this.blogPost, blogPost);
    }
