...
public class VeinImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Vein {
    ...
    private List<AnatomicalStructure> tributary;
     ...
     */
    @Override
    public List<AnatomicalStructure> getTributaryList() {
        return tributary;
    }
     ...
     */
    @Override
    public void addTributary(AnatomicalStructure tributary) {
        this.tributary = add(this.tributary, tributary);
    }
     ...
     */
    @Override
    public List<Vessel> getDrainsToList() {
        return drainsTo;
    }
     ...
     */
    @Override
    public void addDrainsTo(Vessel drainsTo) {
        this.drainsTo = add(this.drainsTo, drainsTo);
    }
