...
public class MenuImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Menu {
    ...
    private List<MenuSection> hasMenuSection;
     ...
     */
    @Override
    public List<MenuSection> getHasMenuSectionList() {
    ...
    public MenuSection getHasMenuSection() {
        return getFirst(hasMenuSection);
    }
     ...
     */
    @Override
    public void addHasMenuSection(MenuSection hasMenuSection) {
        this.hasMenuSection = add(this.hasMenuSection, hasMenuSection);
    }

    private List<MenuItem> hasMenuItem;
     ...
     */
    @Override
    public List<MenuItem> getHasMenuItemList() {
        return hasMenuItem;
    }
     ...
     */
    @Override
    public void addHasMenuItem(MenuItem hasMenuItem) {
        this.hasMenuItem = add(this.hasMenuItem, hasMenuItem);
    }
