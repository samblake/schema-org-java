...
public class ClassImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Class {
    ...
    @JsonLdFieldTypes({ Class.class, Property.class, Enumeration.class })
    private List<Object> supersededBy;
     ...
     */
    @Override
    public <T> List<T> getSupersededByList() {
        return (List<T>) supersededBy;
    }
    ...
    public <T> T getSupersededBy() {
        return (T) getFirst(supersededBy);
    }
    ...
    public void addSupersededBy(Class supersededBy) {
        this.supersededBy = add(this.supersededBy, supersededBy);
    }
    /**
     * Relates a term (i.e. a property, class or enumeration) to one that supersedes it.
     *
